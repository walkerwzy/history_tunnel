...
在这个阶段需要先确定一个数据库方案，我期望能有一个能支持我这种需求的数据库，我需要你帮我分析一下，并给出一个推荐。
如果postgresql能满足需求，在后续的数据库操作中，使用如下连接字符串
psql 'postgresql://neondb_owner:npg_OoTY3udR5ElK@ep-aged-rice-ahgrgzju-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
